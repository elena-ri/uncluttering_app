const graphData = {
  "nodes": {
    ...
    "FIRST_QUESTION": "Does this item <b>belong to you</b> or to someone else?",
    ...
    "D": "Do you think it is <b>over 50 % (or even over 75 %) likely</b> that you will actually do the thing?",
    ...
    "M": "Would you <b>use it in the next X months</b> if it was working?",
    "N": "Is it <b>possible to fix it?</b>",
    "O": "We will now guide you back to the same question that you would be asked if you had used it recently, but I wanted you to be aware of the fact that <b>you haven't needed it for a long-ish time.</b>",
    "P": "Should you have <b>given it back</b> already?",
    "Q": "This is a new entry for your to do list: <b>Give this item back</b> to them as soon as possible!",
    "IS_THIS_THE_END": "Congrats for figuring out what to do about this item! Are there <b>more items</b> you want to go through using this application?",
    "END": "Congrats, you're done for now. Have an awesome day!",
    "P1": "Do you <b>have a date</b> until when you should or want to give it back?",
    "P2": "Would it make sense to <b>add it to your calendar</b> so you don't forget it?",
    ...
    "AC": "Put it in the space for things to sell. Also, you now have a new entry for your to do list: Figuring out how, where and when to sell this item.",
    "AD": "<b>Donate or gift it!</b> Here are some ideas for what do to:<ul><li>You can place it in a box outside your home so people who pass by can pick it up. But be sure to not put anything in there that would be dangerous for kids or animals. And be sure to take care of it, when there are items left and not let it rot on the street.</li><li>You could bring it to a charity shop.</li><li>Maybe you know someone who would really love this and you can gift it to them (but be sure that they *really* would love to have it, nobody wants to feel like you're unloading their junk onto them)</li></ul>",
    "AE": "Here are some ideas for <b>how to find out</b>:<ul><li>Ask someone you know</li><li>Look into a marketplace for used goods and see if people are putting stuff like this online</li><li>Bring to a charity shop and ask them if they would accept it. They have a feeling for what they will be able to resell and what not</li></ul>Ask around until you have an answer as to whether other people would stil use it.",
    "AF": "Do you know how and where to <b>trash or recycle</b> it?",
    ...
    "AQ1(\"Before we consider where to put this item, is there anything you can do to <b>improve this items life span</b>? For example, remove the batteries so they don't leak or put it in a protective case so that it doesn't scratch easily.\")<b>": "pattern of node not matched",
    "AS": "Does it <b>affect you enough</b> that you would be willing to invest effort, time and money into improving it?",
    "AT": "Is it <b>possible to improve</b> this item? [all the items after this are very much unfinished]",
    "AU": "Get it done!",
    "AV": "Do some research!",
    "AW": "Alright, then you probably just have to make peace with it.",
    "AX": "Okay, so do you want to <b>put it on a todo list</b>, something with low priority or a very late deadline?",
    "AZ": "Okay, so my reading is that you're not interested to put effort into improving it and it's not important enough to put it on a todo list. So my suggestion would be that there's <b>nothing you need to do here right now</b> but to figure out where to keep this item.",
    ...
    "BT": "Where would be a better place for this?<ul><li>group it together with <b>items of similar function</b>, for example put the tissues in the same spot as other health related items, like band-aids (either add to an existing group or create a new one)</li><li>somewhere were you can <b>grab it more easily</b> (this could be for items that you use regularly but have to grab out of back end of the bottom shelf every time)</li><li><b>file or store away</b>, this is for items that you use rarely but still want or need to keep, like some paperwork or seasonal gear</li><li><b>out of sight</b>, for example an item that you don't like the look of or that you don't want to be reminded of all the time</li><li><b>within sight</b>, for example, placing the dental floss where you can see it when brushing your teeth, so you don't forget about it</li>",
    "BU": "Put it in the new place!",
    "Y31": "Do you <b>feel good about the place</b> you keep it right now?",
    "Y32": "Y32",
    "Y5": "Is this container <b>over or under its holding capacity</b> in a way that bugs you? Is it way to big and it bugs you that it takes up too much space? Or is overflowing and maybe you can't properly close it and/or don't find anything in there? Have you worried it'll break down because it carries too much weight?",
    "Y6": "Find a <b>better container</b> and put the items in there.",
    "Y7": "Do you <b>already have a container of similar items</b> that you could just put it into?",
    "Y8": "Alright, put the items in there!",
    "Y9": "Okay, your job now is to: <ul><li>get an overview of which items you would like to store together</li><li>figure it which container they might fit in</li><li>get this container and put the items inside</li></ul>",
    ...
    "CF": "For once, you should have already gone through the question about whether you could easily get a new item. If not, I added a button for you to go there (again).<br><br>Of course it's possible that you still feel like you made a mistake, then... [will add more information!]",
    "CG": "CG",
    ...
    "CN": "Alright, put it in the special place!",
    "CO": "Okay, so now you have acquired a new item for your todo list. Let's go through that routine",
    "AQ1": "AQ1",
    "AQ2": "Do this!"
  },
  "edges": [
    ...
    },
    {
      "from": "START",
      "to": "INSTRUCTIONS",
      "label": "Show me the instructions"
    },
    {
      "from": "INSTRUCTIONS",
      "to": "FIRST_QUESTION",
      "label": "Okay, I'd like to begin"
    },
    {
      "from": "FIRST_QUESTION",
      "to": "A",
      "label": "It belongs to me."
    },
    {
      "from": "A",
      "to": "B",
    ...
    },
    {
      "from": "C",
      "to": "E",
      "label": "No, I'm not really not sure"
    },
    {
      "from": "A",
      "to": "F",
    ...
    },
    {
      "from": "G",
      "to": "J",
      "label": "Not sure. I haven't used it in a while or I haven't yet used all of its functions. I don't really know what it can do for me."
    },
    {
      "from": "G",
      "to": "K",
      "label": "Only if one or more other options broke down. It would not be my first choice."
    },
    {
      "from": "G",
      "to": "L",
    ...
    },
    {
      "from": "F",
      "to": "M",
      "label": "No, but I would have if it wasn't broken"
    },
    {
      "from": "M",
      "to": "N",
    ...
    },
    {
      "from": "P",
      "to": "P1",
      "label": "No, it's okay to keep it for a while longer"
    },
    {
      "from": "P1",
      "to": "P2",
    ...
    },
    {
      "from": "R",
      "to": "T",
      "label": "The time it takes it not an issue. I've avoided doing this task because it feels emotionally challenging."
    },
    {
      "from": "T",
      "to": "U",
      "label": "I'll probably experience some feelings that are hard to handle."
    },
    {
      "from": "U",
      "to": "V",
    ...
    },
    {
      "from": "W",
      "to": "X",
      "label": "There are other steps that need to be completed first"
    },
    {
      "from": "X",
      "to": "IS_THIS_THE_END",
    ...
    },
    {
      "from": "X",
      "to": "Y",
      "label": "If this not a great option: Let's figure out a better place to store it."
    },
    {
      "from": "W",
      "to": "X",
      "label": "It takes more time than I'm willing to invest right now."
    },
    {
      "from": "W",
      "to": "X",
      "label": "Right now is not the right time. I promise, this is not just an excuse to continue avoiding this task."
    },
    {
      "from": "D",
      "to": "D",
      "label": "There's no choice, I have to [link missing]"
    },
    {
      "from": "D",
      "to": "Z",
    ...
    },
    {
      "from": "AF",
      "to": "AI",
      "label": "Wait, you want me to throw it away? I don't feel great about that."
    },
    {
      "from": "H",
      "to": "AN",
    ...
    },
    {
      "from": "AN",
      "to": "AO",
      "label": "Yes/It's really not important at all."
    },
    {
      "from": "AO",
      "to": "AP",
    ...
    },
    {
      "from": "AO",
      "to": "AO1",
      "label": "No, but maybe I should have several of these as a backup, stock or replacement?"
    },
    {
      "from": "AO1",
      "to": "AQ",
    ...
    {
      "from": "AQ",
      "to": "AQ1(\"Before we consider where to put this item, is there anything you can do to <b>improve this items life span</b>? For example, remove the batteries so they don't leak or put it in a protective case so that it doesn't scratch easily.\")<b>",
      "label": "Yes"
    },
    {
      "from": "AQ",
      "to": "AR",
      "label": "Sigh, I'm conflicted"
    },
    {
      "from": "AO",
      "to": "AQ",
      "label": "No, and I don't want or need more"
    },
    {
      "from": "AN",
      "to": "AS",
      "label": "It's not great, but I've never thought about replacing it."
    },
    {
      "from": "AS",
      "to": "AT",
    ...
    },
    {
      "from": "AN",
      "to": "AS",
      "label": "It's not great, but I've really thought about replacing it (potentially more often than once, over a longer period of time)"
    },
    {
      "from": "AN",
      "to": "AS",
      "label": "No, I don't like it very much"
    },
    {
      "from": "H",
      "to": "N",
      "label": "There are issues"
    },
    {
      "from": "N",
      "to": "BD",
    ...
    },
    {
      "from": "BE",
      "to": "B",
      "label": "You could header over to an earlier section to manage these tasks"
    },
    {
      "from": "BE",
      "to": "IS_THIS_THE_END",
    ...
    },
    {
      "from": "N",
      "to": "BH",
      "label": "Not sure, I don't have the necessary knowledge."
    },
    {
      "from": "BH",
      "to": "N",
    ...
    },
    {
      "from": "N",
      "to": "BD",
      "label": "Not sure. I know what I could do, but I haven't tried if it solves the issue"
    },
    {
      "from": "N",
      "to": "BA",
    ...
    },
    {
      "from": "L",
      "to": "AR",
      "label": "Enough so that I can see why I think of keeping it."
    },
    {
      "from": "AR",
      "to": "BI",
    ...
    },
    {
      "from": "BI",
      "to": "AA",
      "label": "Great, let's do it!"
    },
    {
      "from": "BI",
      "to": "AA",
      "label": "Not great, but I'm willing to go on."
    },
    {
      "from": "BI",
      "to": "BJ",
      "label": "I feel vaguely or intensely bad about it"
    },
    {
      "from": "BI",
      "to": "AD",
    ...
    },
    {
      "from": "AR",
      "to": "BK",
      "label": "Probably yes. But next time, I would have to pay way more than I paid when getting it in the first place. It's not too expensive, but I would still be bothered. [link missing]"
    },
    {
      "from": "AR",
      "to": "BL",
      "label": "No, because it has emotional meaning for me/I want to keep it as a memory."
    },
    {
      "from": "BL",
      "to": "BM",
    ...
    },
    {
      "from": "AR",
      "to": "BN",
      "label": "No, because it would be too expensive. [link missing]"
    },
    {
      "from": "AR",
      "to": "BO",
    ...
    },
    {
      "from": "V",
      "to": "R",
      "label": "Okay, I have a plan that feels good enough for me."
    },
    {
      "from": "V",
      "to": "BR",
      "label": "I don't know, I feel really lost."
    },
    {
      "from": "BR",
      "to": "IS_THIS_THE_END",
    ...
    },
    {
      "from": "Y3",
      "to": "BT",
      "label": "I'd be interested in some ideas about what I could improve."
    },
    {
      "from": "BT",
      "to": "BU",
    ...
    },
    {
      "from": "Y",
      "to": "Y3",
      "label": "No, and it's not necessary."
    },
    {
      "from": "AC",
      "to": "B",
      "label": "Well, now there's a task associated with this item, so now you could head over to another section to manage this task"
    },
    {
      "from": "AC",
      "to": "IS_THIS_THE_END",
      "label": "Or you could just say you're done for now by placing it in the selling space."
    },
    {
      "from": "AD",
      "to": "IS_THIS_THE_END",
      "label": "I'm fine with that"
    },
    {
      "from": "AD",
      "to": "AF",
      "label": "I don't know, it's not really something you would donate. Maybe because it's too small, too cheap. Or it's not even worth this kind of effort to me."
    },
    {
      "from": "AG",
      "to": "BW",
    ...
    },
    {
      "from": "BW",
      "to": "B",
      "label": "Technically you now have a task connected to this item, so you could head over to an earlier section"
    },
    {
      "from": "BW",
      "to": "BX",
      "label": "Or you could just continue here."
    },
    {
      "from": "BX",
      "to": "IS_THIS_THE_END",
    ...
    },
    {
      "from": "AI",
      "to": "BY",
      "label": "It's not really something you throw away because it has some kind of immaterial value. Like books for example."
    },
    {
      "from": "BY",
      "to": "AF",
    ...
    },
    {
      "from": "AI",
      "to": "BZ",
      "label": "It's not really something you should put into trash because of it's material and/or material value, for example a small amount of foreign coins (but from a country you'll probably never visit again)"
    },
    {
      "from": "BZ",
      "to": "AF",
    ...
    },
    {
      "from": "AI",
      "to": "CA",
      "label": "Why should I give something away that works perfectly fine but just isn't ~pErFeCt~ for me?"
    },
    {
      "from": "CA",
      "to": "AF",
      "label": "You got me here. Let's do it, let's get rid of it."
    },
    {
      "from": "CA",
      "to": "CB",
      "label": "Still hesitant [link missing]"
    },
    {
      "from": "AU",
      "to": "IS_THIS_THE_END",
    ...
    },
    {
      "from": "BC",
      "to": "Y",
      "label": "Live with it. Just let it be."
    },
    {
      "from": "BC",
      "to": "AA",
    ...
    },
    {
      "from": "BJ",
      "to": "CD",
      "label": "There's a sense of guilt around letting stuff go, especially if it has to be thrown away. (Maybe because you feel the resources that went into creating this item were wasted, because you add to growing trash piles keep growing, ...)"
    },
    {
      "from": "CD",
      "to": "BI",
    ...
    },
    {
      "from": "BJ",
      "to": "CE",
      "label": "I would feel bad about having wasted the money, time, effort I put into getting it."
    },
    {
      "from": "CE",
      "to": "BI",
    ...
    },
    {
      "from": "BJ",
      "to": "CF",
      "label": "What if I let it go and later figure out I made a mistake?"
    },
    {
      "from": "CF",
      "to": "AR",
      "label": "Let's figure out if I can easily get the same or a similar item"
    },
    {
      "from": "BJ",
      "to": "CG",
      "label": "Why should I give something away that works perfectly fine but just isn't ~pErFeCt~ for me? [link missing]"
    },
    {
      "from": "BJ",
      "to": "CH",
      "label": "This was a gift from someone so it feels wrong to give it away"
    },
    {
      "from": "CH",
      "to": "BI",
    ...
    },
    {
      "from": "CM",
      "to": "CN",
      "label": "I'm fine with putting it away."
    },
    {
      "from": "CN",
      "to": "IS_THIS_THE_END",
